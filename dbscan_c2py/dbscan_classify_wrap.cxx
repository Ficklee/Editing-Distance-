...
/*-----------------------------------------------
              @(target):= _Corpus_classify.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Corpus_classify

#else
#  define SWIG_init    init_Corpus_classify

#endif
#define SWIG_name    "_Corpus_classify"
...
SWIGINTERN PyObject *_wrap_dbscan_classify(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::string,std::allocator< std::string > > arg1 ;
  PyObject * obj0 = 0 ;
  std::vector< int,std::allocator< int > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:dbscan_classify",&obj0)) SWIG_fail;
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    int res = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "dbscan_classify" "', argument " "1"" of type '" "std::vector< std::string,std::allocator< std::string > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = dbscan_classify(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"dbscan_classify", _wrap_dbscan_classify, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
